...
void BldWarnings::Damage_Event(DamageableGameObj *Victim, ArmedGameObj *Damager, float Damage, unsigned int Warhead, float Scale, DADamageType::Type Type)
{
		...
		{
			DA::Team_Color_Message_With_Team_Color(Victim->Get_Player_Type(), "%s The %s health at 75 percent", DA::Get_Message_Prefix(), DATranslationManager::Translate(Victim));
		...
		{
			DA::Team_Color_Message_With_Team_Color(Victim->Get_Player_Type(), "%s The %s health at 50 percent", DA::Get_Message_Prefix(), DATranslationManager::Translate(Victim));
		...
		{
			DA::Team_Color_Message_With_Team_Color(Victim->Get_Player_Type(), "%s The %s health at 25 percent", DA::Get_Message_Prefix(), DATranslationManager::Translate(Victim));
